...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010182043315.png)
...
![image-20211010182038739](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010182038739.png)
...
在[React中如何避免不必要的render]中，我们了解到如何避免不必要的`render`来应付上面的问题，主要手段是通过`shouldComponentUpdate`、`PureComponent`、`React.memo`，这三种形式这里就不再复述
...
在[理解Immutable中]()，我们了解到使用 `Immutable`可以给 `React` 应用带来性能的优化，主要体现在减少渲染的次数
