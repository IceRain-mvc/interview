...
![image-20211010181657876](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181657876.png)

## 一、背景

在[Redux介绍中]，我们了解到`redux`是用于数据状态管理，而`react`是一个视图层面的库
...
![image-20211010181647245](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181647245.png)
