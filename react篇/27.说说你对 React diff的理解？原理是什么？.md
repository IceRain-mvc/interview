# 面试官：说说你对 React diff的理解？原理是什么？





![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181928559.png)
...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181923802.png)
...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181919190.png)

只有删除、创建操作，没有移动操作，如下图：

![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181915051.png)
...
![image-20211010181910851](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181910851.png)
...
![image-20211010181906319](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181906319.png)

通过`key`可以准确地发现新旧集合中的节点都是相同的节点，因此无需进行节点删除和创建，只需要将旧集合中节点的位置进行移动，更新为新集合中节点的位置

流程如下表：

![image-20211010181900486](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010181900486.png)
