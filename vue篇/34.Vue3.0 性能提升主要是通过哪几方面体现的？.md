...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010191553734.png)

## 一、编译阶段

回顾`Vue2`，我们知道每个组件实例都对应一个 `watcher` 实例，它会在组件渲染的过程中把用到的数据`property`记录为依赖，当依赖发生改变，触发`setter`，则会通知`watcher`，从而使关联的组件重新渲染

![image-20211010191547260](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010191547260.png)
...
![image-20211010191533368](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010191533368.png)
