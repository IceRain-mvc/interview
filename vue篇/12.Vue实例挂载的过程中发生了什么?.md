...
![image-20211010184742349](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010184742349.png)
...
`updateComponent`方法主要执行在`vue`初始化时声明的`render`，

`update`方法`render`的作用主要是生成`vnode`
