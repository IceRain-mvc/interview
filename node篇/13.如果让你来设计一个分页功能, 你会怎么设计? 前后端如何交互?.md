...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010173348184.png)

## 一、是什么

在我们做数据查询的时候，如果数据量很大，比如几万条数据，放在一个页面显示的话显然不友好，这时候就需要采用分页显示的形式，如每次只显示10条数据

![image-20211010173341504](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010173341504.png)
