...
![image-20211010165353742](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010165353742.png)

## 一、前言

`git`的操作可以通过命令的形式执行，日常使用就如下图6个命令即可

![image-20211010165348944](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010165348944.png)
...
![image-20211010165339184](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010165339184.png)