...
![image-20211010214006857](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010214006857.png)

并且继承该类的子类并不能访问，如下图所示：

![image-20211010214027636](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010214027636.png)

### 受保护修饰符

跟私有修饰符很相似，实例对象同样不能访问受保护的属性，如下：

![image-20211010214042031](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20211010214042031.png)
